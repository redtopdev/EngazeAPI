...
namespace WatchUs.EncryptionManager
{
    public class RijndaelManagedEncryption : IEncryptionManager
    {
        #region Consts
        /// <summary>
        ...
        /// </summary>
        //internal const 
        string Inputkey; //= ConfigurationManager.AppSettings["RIJNDAELKEY"];
        #endregion

        public RijndaelManagedEncryption(string key)
        {
            Inputkey = key;
        }
